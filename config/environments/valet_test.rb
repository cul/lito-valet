# config/environments/valet_test.rb
#
# Rebuilt against the Rails 7.2 production.rb template.
# Differs from valet_prod.rb only in: log level, deprecation reporting,
# attributes_for_inspect, and the mailer host.
...
Rails.application.configure do
  ...
  # log/valet_test.log. Capistrano links `log` to shared/log, so those
  # survive releases.
  #
  ...
  # with no subscriber -- i.e. silently discarded them. This is the
  # environment where Rails 8 deprecation warnings should be loudest.
  ...
  config.action_mailer.default_url_options = {
    host: "valet-test.cul.columbia.edu", protocol: "https"   # SITE:
  }
  ...
  # === Host authorization =============================================
  # config.hosts = ["valet-test.cul.columbia.edu"]
